...
(defun player-attack ()
  ...
  (case (read)
    ...
    (d (let ((x (randval (truncate (/ *player-strength* 6)))))
         (princ "Your double swing has a strengs of ")
         (princ x)
         (fresh-line)
...
(defmethod monster-attack ((m slime-mold))
  (let ((x (randval (slime-mold-sliminess m))))
    (princ "A slime mold wraps around your legs and decrease your agility by ")
    (princ x)
    (princ "! ")
...
(defmethod monster-attack ((m brigand))
  (let ((x (max *player-helth* *player-agility* *player-strength*)))
    (cond ((= x *player-helth*)
